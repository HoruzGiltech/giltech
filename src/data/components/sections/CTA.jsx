...
export function CTA({ onOpenContact }) {
  return (
    <section className="py-24 bg-[#0F1E29] text-center border-t border-white/10 relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        ...
        <button onClick={onOpenContact} className="inline-flex items-center justify-center px-6 py-3 font-semibold rounded-lg transition-all duration-300 transform hover:-translate-y-1 bg-[#00CED1] text-[#0F1E29] hover:bg-opacity-90 shadow-[0_4px_14px_0_rgba(0,206,209,0.39)] text-lg px-8 py-4 mb-4 shadow-[0_0_30px_rgba(0,206,209,0.3)]">
